...
public class Commandbroadcast implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		// We don't have to make a player as it's unnecessary, because if sender = console, he has all permissions.
		...
		Bukkit.broadcastMessage(ChatColor.GOLD + "[Broadcast]" + broadcastMessage);
			...
			sender.sendMessage(ChatColor.RED + "If you believe this is incorrect, contact an operator.");
		}
